...
namespace zattera { namespace protocol {
   ...
   {
      return fc::sha256::hash( chain_id_name );
   }
...
namespace fc
{
    ...
    {
        vo = zattera::protocol::public_key_type( var.as_string() );
    }
    ...
    {
       vo = zattera::protocol::extended_public_key_type( var.as_string() );
    }
    ...
    {
       vo = zattera::protocol::extended_private_key_type( var.as_string() );
    }
} // fc
