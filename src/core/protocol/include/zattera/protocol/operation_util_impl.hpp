...
//
// Place ZATTERA_DEFINE_OPERATION_TYPE in a .cpp file to define
// functions related to your operation type
//
#define ZATTERA_DEFINE_OPERATION_TYPE( OperationType )                       \
                                                                           \
namespace zattera { namespace protocol {                                     \
                                                                           \
void operation_validate( const OperationType& op )                         \
{                                                                          \
   op.visit( zattera::protocol::operation_validate_visitor() );              \
}                                                                          \
                                                                           \
...
{                                                                          \
   op.visit( zattera::protocol::get_required_auth_visitor( active, owner, posting, other ) ); \
}                                                                          \
                                                                           \
} } /* zattera::protocol */
