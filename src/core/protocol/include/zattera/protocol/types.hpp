...
#include <zattera/protocol/asset_symbol.hpp>
#include <zattera/protocol/fixed_string.hpp>
...
namespace fc
{
    void to_variant( const zattera::protocol::public_key_type& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  zattera::protocol::public_key_type& vo );
    void to_variant( const zattera::protocol::extended_public_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, zattera::protocol::extended_public_key_type& vo );
    void to_variant( const zattera::protocol::extended_private_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, zattera::protocol::extended_private_key_type& vo );
}

FC_REFLECT( zattera::protocol::public_key_type, (key_data) )
FC_REFLECT( zattera::protocol::public_key_type::binary_key, (data)(check) )
FC_REFLECT( zattera::protocol::extended_public_key_type, (key_data) )
FC_REFLECT( zattera::protocol::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( zattera::protocol::extended_private_key_type, (key_data) )
FC_REFLECT( zattera::protocol::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_TYPENAME( zattera::protocol::share_type )

FC_REFLECT( zattera::void_t, )
