...
/*
 * This class represents the basic versioning scheme of the Zattera blockchain.
...
{
   class variant;
   void to_variant( const zattera::protocol::version& v, variant& var );
   void from_variant( const variant& var, zattera::protocol::version& v );

   void to_variant( const zattera::protocol::hardfork_version& hv, variant& var );
   void from_variant( const variant& var, zattera::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( zattera::protocol::version, (v_num) )
FC_REFLECT_DERIVED( zattera::protocol::hardfork_version, (zattera::protocol::version), )

FC_REFLECT( zattera::protocol::hardfork_version_vote, (hf_version)(hf_time) )
