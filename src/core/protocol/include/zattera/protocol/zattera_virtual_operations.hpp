...
FC_REFLECT( zattera::protocol::liquidity_reward_operation, (owner)(payout) )
FC_REFLECT( zattera::protocol::interest_operation, (owner)(interest) )
FC_REFLECT( zattera::protocol::fill_vesting_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )
FC_REFLECT( zattera::protocol::shutdown_witness_operation, (owner) )
FC_REFLECT( zattera::protocol::fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) )
FC_REFLECT( zattera::protocol::fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
FC_REFLECT( zattera::protocol::hardfork_operation, (hardfork_id) )
FC_REFLECT( zattera::protocol::comment_payout_update_operation, (author)(permlink) )
FC_REFLECT( zattera::protocol::return_vesting_delegation_operation, (account)(vesting_shares) )
FC_REFLECT( zattera::protocol::comment_benefactor_reward_operation, (benefactor)(author)(permlink)(reward) )
FC_REFLECT( zattera::protocol::producer_reward_operation, (producer)(vesting_shares) )
