...
#include <zattera/protocol/validation.hpp>
#include <zattera/protocol/legacy_asset.hpp>
...
namespace zattera { namespace protocol {
    ...
    *  The percent_zattera_dollars may be decreased, but never increased
    *
    */
    ...
    * @ingroup operations
    *
    * @brief Transfers ZTR from one account to another.
    */
   ...
   /**
    *  This operation converts liquid token (ZTR) into VFS (Vesting Fund Shares, VESTS) 
    ...
    * vests to ztr and back, guaranteeing they maintain their value.
    */
   ...
   {
      /**
       *  This fee, paid in ZTR, is converted into VESTING SHARES for the new account. Accounts
       *  without vesting shares cannot earn usage rations and therefore are powerless. This minimum
       *  fee requires all accounts to have some kind of commitment to the network that includes the
       *  ability to vote and make transactions.
       */
      legacy_zattera_asset account_creation_fee = legacy_zattera_asset::from_amount( ZATTERA_MIN_ACCOUNT_CREATION_FEE );
   ...
   struct witness_set_properties_operation : public base_operation
   {
      ...
      void get_required_authorities( vector< authority >& a )const
      {
         ...
         if( key_itr != props.end() )
         {
            ...
            a.push_back( authority( 1, ZATTERA_NULL_ACCOUNT, 1 ) ); // The null account auth is impossible to satisfy
      }
   };
   ...
   /**
    *  This operation instructs the blockchain to start a conversion between ZTR and ZBD,
    *  The funds are deposited after ZATTERA_CONVERSION_DELAY
    */
    ...
    * ZATTERA_MAX_WITNESSES blocks of the head block (1 round) and the
    * producer must be in the ACTIVE witness set.
    *
    * Users not in the ACTIVE witness set should not have to worry about their
    * key getting compromised and being used to produced multiple blocks so
    * the attacker can report it and steel their vesting zattera.
    *
    * The result of the operation is to transfer the full vesting zattera balance
...
FC_REFLECT( zattera::protocol::transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( zattera::protocol::transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( zattera::protocol::cancel_transfer_from_savings_operation, (from)(request_id) )

FC_REFLECT( zattera::protocol::reset_account_operation, (reset_account)(account_to_reset)(new_owner_authority) )
FC_REFLECT( zattera::protocol::set_reset_account_operation, (account)(current_reset_account)(reset_account) )


FC_REFLECT( zattera::protocol::report_over_production_operation, (reporter)(first_block)(second_block) )
FC_REFLECT( zattera::protocol::convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( zattera::protocol::feed_publish_operation, (publisher)(exchange_rate) )
...
FC_REFLECT( zattera::protocol::account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( zattera::protocol::account_update_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( zattera::protocol::transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( zattera::protocol::transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( zattera::protocol::withdraw_vesting_operation, (account)(vesting_shares) )
FC_REFLECT( zattera::protocol::set_withdraw_vesting_route_operation, (from_account)(to_account)(percent)(auto_vest) )
FC_REFLECT( zattera::protocol::witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( zattera::protocol::witness_set_properties_operation, (owner)(props)(extensions) )
FC_REFLECT( zattera::protocol::account_witness_vote_operation, (account)(witness)(approve) )
FC_REFLECT( zattera::protocol::account_witness_proxy_operation, (account)(proxy) )
FC_REFLECT( zattera::protocol::comment_operation, (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata) )
FC_REFLECT( zattera::protocol::vote_operation, (voter)(author)(permlink)(weight) )
FC_REFLECT( zattera::protocol::custom_operation, (required_auths)(id)(data) )
FC_REFLECT( zattera::protocol::custom_json_operation, (required_auths)(required_posting_auths)(id)(json) )
FC_REFLECT( zattera::protocol::custom_binary_operation, (required_owner_auths)(required_active_auths)(required_posting_auths)(required_auths)(id)(data) )
FC_REFLECT( zattera::protocol::limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( zattera::protocol::limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( zattera::protocol::limit_order_cancel_operation, (owner)(orderid) )

FC_REFLECT( zattera::protocol::delete_comment_operation, (author)(permlink) );

FC_REFLECT( zattera::protocol::beneficiary_route_type, (account)(weight) )
FC_REFLECT( zattera::protocol::comment_payout_beneficiaries, (beneficiaries) )
