 ...
 * - Length is between (inclusive) ZATTERA_MIN_ACCOUNT_NAME_LENGTH and ZATTERA_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace zattera::protocol


FC_REFLECT_TYPENAME( zattera::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( zattera::protocol::authority::key_authority_map)
FC_REFLECT( zattera::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( zattera::protocol::authority::classification, (owner)(active)(key)(posting) )
