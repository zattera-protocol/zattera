...
namespace zattera { namespace chain {
   ...
   using zattera::protocol::weight_type;
...
FC_REFLECT_TYPENAME( zattera::chain::shared_authority::account_authority_map)
FC_REFLECT( zattera::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
