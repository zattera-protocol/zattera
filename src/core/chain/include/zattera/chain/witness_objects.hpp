...
namespace zattera { namespace chain {
   ...
   using zattera::protocol::digest_type;
   using zattera::protocol::public_key_type;
   using zattera::protocol::version;
   using zattera::protocol::hardfork_version;
   ...
   class witness_object : public object< witness_object_type, witness_object >
   {
      ...
      public:
         ...
         /**
          * This field represents the Zattera blockchain version the witness is running.
          */
         version           running_version;

         hardfork_version  hardfork_version_vote;
         time_point_sec    hardfork_time_vote = ZATTERA_GENESIS_TIME;
   };
   ...
   class witness_schedule_object : public object< witness_schedule_object_type, witness_schedule_object >
   {
      public:
         ...
         fc::array< account_name_type, ZATTERA_MAX_WITNESSES >               current_shuffled_witnesses;
         ...
         uint8_t max_voted_witnesses            = ZATTERA_MAX_VOTED_WITNESSES;
         uint8_t max_runner_witnesses           = ZATTERA_MAX_RUNNER_WITNESSES;
         uint8_t hardfork_required_witnesses    = ZATTERA_HARDFORK_REQUIRED_WITNESSES;
   };
...
FC_REFLECT_ENUM( zattera::chain::witness_object::witness_schedule_type, (top20)(timeshare)(none) )
...
FC_REFLECT( zattera::chain::witness_object,
             (id)
             (owner)
             (created)
...
CHAINBASE_SET_INDEX_TYPE( zattera::chain::witness_object, zattera::chain::witness_index )

FC_REFLECT( zattera::chain::witness_vote_object, (id)(witness)(account) )
CHAINBASE_SET_INDEX_TYPE( zattera::chain::witness_vote_object, zattera::chain::witness_vote_index )

FC_REFLECT( zattera::chain::witness_schedule_object,
...
CHAINBASE_SET_INDEX_TYPE( zattera::chain::witness_schedule_object, zattera::chain::witness_schedule_index )
