...
FC_REFLECT( zattera::chain::transaction_object, (id)(packed_trx)(trx_id)(expiration) )
CHAINBASE_SET_INDEX_TYPE( zattera::chain::transaction_object, zattera::chain::transaction_index )

namespace helpers
{
   template <>
   class index_statistic_provider<zattera::chain::transaction_index>
   {
   public:
      typedef zattera::chain::transaction_index IndexType;
      typedef typename zattera::chain::transaction_object::t_packed_trx t_packed_trx;
