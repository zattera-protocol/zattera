...
#include <zattera/chain/buffer_type.hpp>
...
FC_REFLECT( zattera::chain::operation_object, (id)(trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(serialized_op) )
CHAINBASE_SET_INDEX_TYPE( zattera::chain::operation_object, zattera::chain::operation_index )

FC_REFLECT( zattera::chain::account_history_object, (id)(account)(sequence)(op) )

CHAINBASE_SET_INDEX_TYPE( zattera::chain::account_history_object, zattera::chain::account_history_index )

namespace helpers
{
   template <>
   class index_statistic_provider<zattera::chain::operation_index>
   {
   public:
      typedef zattera::chain::operation_index IndexType;
         ...
         if(onlyStaticInfo == false)
         {
            for(const auto& o : index)
               info._item_additional_allocation +=
                  o.serialized_op.capacity()*sizeof(zattera::chain::buffer_type::value_type);
         }
   ...
   template <>
   class index_statistic_provider<zattera::chain::account_history_index>
   {
   public:
      typedef zattera::chain::account_history_index IndexType;
      ...
      index_statistic_info gather_statistics(const IndexType& index, bool onlyStaticInfo) const
      {
         ...
         if(onlyStaticInfo == false)
         {
            ...
            //      sizeof(zattera::chain::account_history_object::operation_container::value_type);
         }
