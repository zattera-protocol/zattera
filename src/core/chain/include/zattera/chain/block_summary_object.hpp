...
FC_REFLECT( zattera::chain::block_summary_object, (id)(block_id) )
CHAINBASE_SET_INDEX_TYPE( zattera::chain::block_summary_object, zattera::chain::block_summary_index )
