...
#include <zattera/chain/node_property_object.hpp>
#include <zattera/chain/operation_notification.hpp>
#include <zattera/chain/transaction_notification.hpp>

#include <zattera/chain/utils/advanced_benchmark_dumper.hpp>
#include <zattera/chain/utils/signal.hpp>
...
namespace zattera { namespace chain {
   ...
   class database : public chainbase::database
   {
      public:
         ...
         struct open_args
         {
            ...
            uint64_t initial_supply = ZATTERA_INIT_SUPPLY;
      ...
      public:
          ...
          *
          * Passing slot_num == 0 returns ZATTERA_NULL_WITNESS
          */
         ...
         void init_schema();
         void init_genesis(uint64_t initial_supply = ZATTERA_INIT_SUPPLY );
   ...
   protected:
      ...
      private:
         ...
         fc::time_point_sec            _hardfork_times[ ZATTERA_NUM_HARDFORKS + 1 ];
         protocol::hardfork_version    _hardfork_versions[ ZATTERA_NUM_HARDFORKS + 1 ];
