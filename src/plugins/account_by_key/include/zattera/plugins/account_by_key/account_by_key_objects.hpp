...
namespace zattera { namespace plugins { namespace account_by_key {

using namespace std;
using namespace zattera::chain;

#ifndef ZATTERA_ACCOUNT_BY_KEY_SPACE_ID
#define ZATTERA_ACCOUNT_BY_KEY_SPACE_ID 11
#endif

enum account_by_key_object_types
{
   key_lookup_object_type = ( ZATTERA_ACCOUNT_BY_KEY_SPACE_ID << 8 )
};
...
} } } // zattera::plugins::account_by_key


FC_REFLECT( zattera::plugins::account_by_key::key_lookup_object, (id)(key)(account) )
CHAINBASE_SET_INDEX_TYPE( zattera::plugins::account_by_key::key_lookup_object, zattera::plugins::account_by_key::key_lookup_index )
