...
#define ZATTERA_BLOCK_LOG_INFO_PLUGIN_NAME "block_log_info"
...
class block_log_info_plugin : public appbase::plugin< block_log_info_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = ZATTERA_BLOCK_LOG_INFO_PLUGIN_NAME; return name; }
