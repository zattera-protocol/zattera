...
using zattera::chain::share_type;
using zattera::chain::asset;
...
FC_REFLECT( zattera::plugins::market_history::get_order_book_return,
            (bids)(asks) )

FC_REFLECT( zattera::plugins::market_history::market_trade,
            (date)(current_pays)(open_pays) )

FC_REFLECT( zattera::plugins::market_history::get_trade_history_args,
            (start)(end)(limit) )

FC_REFLECT( zattera::plugins::market_history::get_trade_history_return,
            (trades) )

FC_REFLECT( zattera::plugins::market_history::get_recent_trades_args,
            (limit) )

FC_REFLECT( zattera::plugins::market_history::get_market_history_args,
            (bucket_seconds)(start)(end) )

FC_REFLECT( zattera::plugins::market_history::get_market_history_return,
            (buckets) )

FC_REFLECT( zattera::plugins::market_history::get_market_history_buckets_return,
            (bucket_sizes) )
