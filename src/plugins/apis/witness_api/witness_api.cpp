#include <zattera/plugins/witness_api/witness_api_plugin.hpp>
...
{
   public:
      witness_api_impl() : _db( appbase::app().get_plugin< zattera::plugins::chain::chain_plugin >().db() ) {}
...
{
   JSON_RPC_REGISTER_API( ZATTERA_WITNESS_API_PLUGIN_NAME );
}
