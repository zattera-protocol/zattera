#include <zattera/plugins/debug_node_api/debug_node_api_plugin.hpp>
#include <zattera/plugins/debug_node_api/debug_node_api.hpp>
...
{
   if( args.hardfork_id > ZATTERA_NUM_HARDFORKS )
      return {};
...
{
   JSON_RPC_REGISTER_API( ZATTERA_DEBUG_NODE_API_PLUGIN_NAME );
}
