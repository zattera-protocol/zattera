...
#define ZATTERA_DEBUG_NODE_API_PLUGIN_NAME "debug_node_api"
...
public:
   ...
   static const std::string& name() { static std::string name = ZATTERA_DEBUG_NODE_API_PLUGIN_NAME; return name; }
