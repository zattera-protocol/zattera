...
struct api_comment_object
{
   api_comment_object( const comment_object& o, const database& db ):
      ...
      percent_zattera_dollars( o.percent_zattera_dollars ),
   ...
   uint16_t          percent_zattera_dollars = 0;
...
FC_REFLECT( zattera::plugins::database_api::api_comment_object,
             (id)(author)(permlink)
             ...
             (max_accepted_payout)(percent_zattera_dollars)(allow_replies)(allow_votes)(allow_curation_rewards)
             (beneficiaries)
          )

FC_REFLECT( zattera::plugins::database_api::api_comment_vote_object,
             (id)(voter)(author)(permlink)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )

FC_REFLECT( zattera::plugins::database_api::api_account_object,
...
FC_REFLECT( zattera::plugins::database_api::api_owner_authority_history_object,
             (id)
             (account)
...
FC_REFLECT( zattera::plugins::database_api::api_account_recovery_request_object,
             (id)
             (account_to_recover)
             (new_owner_authority)
             (expires)
...
FC_REFLECT( zattera::plugins::database_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( zattera::plugins::database_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( zattera::plugins::database_api::api_witness_object,
             (id)
             (owner)
             (created)
...
FC_REFLECT( zattera::plugins::database_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT_DERIVED( zattera::plugins::database_api::api_signed_block_object, (zattera::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT( zattera::plugins::database_api::api_hardfork_property_object,
            (id)
            (processed_hardforks)
            (last_hardfork)
