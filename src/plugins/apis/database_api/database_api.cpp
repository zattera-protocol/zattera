...
#include <zattera/protocol/transaction_util.hpp>
...
{
   JSON_RPC_REGISTER_API( ZATTERA_DATABASE_API_PLUGIN_NAME );
}
...
{
   return zattera::protocol::get_config();
}
...
DEFINE_API_IMPL( database_api_impl, verify_signatures )
{
   ...
   try
   {
      zattera::protocol::verify_authority< verify_signatures_args >(
         { args },
         sig_keys,
