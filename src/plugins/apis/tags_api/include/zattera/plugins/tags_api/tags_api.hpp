...
#include <zattera/plugins/tags/tags_plugin.hpp>
...
namespace zattera { namespace plugins { namespace tags {
...
{
   discussion( const zattera::chain::comment_object& o, const zattera::chain::database& db ) :
   ...
   string                        root_title;
   asset                         pending_payout_value; ///< zbd
   asset                         total_pending_payout_value; ///< zbd including replies
   vector< vote_state >          active_votes;
   vector< string >              replies; ///< author/slug mapping
   share_type                    author_reputation = 0;
   asset                         promoted = asset(0, DOLLAR_SYMBOL);
...
} } } // zattera::plugins::tags

FC_REFLECT( zattera::plugins::tags::api_tag_object,
            (name)(total_payouts)(net_votes)(top_posts)(comments)(trending) )

FC_REFLECT( zattera::plugins::tags::vote_state,
            (voter)(weight)(rshares)(percent)(reputation)(time) )

FC_REFLECT_DERIVED( zattera::plugins::tags::discussion, (zattera::plugins::database_api::api_comment_object),
...
FC_REFLECT( zattera::plugins::tags::get_trending_tags_args,
            (start_tag)(limit) )

FC_REFLECT( zattera::plugins::tags::get_trending_tags_return,
            (tags) )

FC_REFLECT( zattera::plugins::tags::get_tags_used_by_author_args,
            (author) )

FC_REFLECT( zattera::plugins::tags::tag_count_object,
            (tag)(count) )

FC_REFLECT( zattera::plugins::tags::get_tags_used_by_author_return,
            (tags) )

FC_REFLECT( zattera::plugins::tags::get_discussion_args,
            (author)(permlink) )

FC_REFLECT( zattera::plugins::tags::discussion_query,
            (tag)(limit)(filter_tags)(select_authors)(select_tags)(truncate_body)(start_author)(start_permlink)(parent_author)(parent_permlink) )

FC_REFLECT( zattera::plugins::tags::discussion_query_result,
            (discussions) )

FC_REFLECT( zattera::plugins::tags::get_replies_by_last_update_args,
            (start_parent_author)(start_permlink)(limit) )

FC_REFLECT( zattera::plugins::tags::get_discussions_by_author_before_date_args,
            (author)(start_permlink)(before_date)(limit) )

FC_REFLECT( zattera::plugins::tags::get_active_votes_return,
            (votes) )
