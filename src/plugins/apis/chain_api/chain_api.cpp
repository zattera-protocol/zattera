#include <zattera/plugins/chain_api/chain_api_plugin.hpp>
#include <zattera/plugins/chain_api/chain_api.hpp>
...
{
   JSON_RPC_REGISTER_API( ZATTERA_CHAIN_API_PLUGIN_NAME );
}
