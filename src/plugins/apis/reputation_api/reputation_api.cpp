#include <zattera/plugins/reputation_api/reputation_api_plugin.hpp>
...
{
   public:
      reputation_api_impl() : _db( appbase::app().get_plugin< zattera::plugins::chain::chain_plugin >().db() ) {}
...
{
   JSON_RPC_REGISTER_API( ZATTERA_REPUTATION_API_PLUGIN_NAME );
}
