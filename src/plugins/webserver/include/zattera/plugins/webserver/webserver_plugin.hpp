...
#define ZATTERA_WEBSERVER_PLUGIN_NAME "webserver"

namespace zattera { namespace plugins { namespace webserver {
...
class webserver_plugin : public appbase::plugin< webserver_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = ZATTERA_WEBSERVER_PLUGIN_NAME; return name; }
