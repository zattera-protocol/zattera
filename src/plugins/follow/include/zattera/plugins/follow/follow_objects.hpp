...
#ifndef ZATTERA_FOLLOW_SPACE_ID
#define ZATTERA_FOLLOW_SPACE_ID 8
#endif

enum follow_plugin_object_type
{
   follow_object_type            = ( ZATTERA_FOLLOW_SPACE_ID << 8 ),
   feed_object_type              = ( ZATTERA_FOLLOW_SPACE_ID << 8 ) + 1,
   reputation_object_type        = ( ZATTERA_FOLLOW_SPACE_ID << 8 ) + 2,
   blog_object_type              = ( ZATTERA_FOLLOW_SPACE_ID << 8 ) + 3,
   follow_count_object_type      = ( ZATTERA_FOLLOW_SPACE_ID << 8 ) + 4,
   blog_author_stats_object_type = ( ZATTERA_FOLLOW_SPACE_ID << 8 ) + 5
};
...
/**
 *  This index is maintained to get an idea of which authors are reblogged by a particular blogger and
 ...
 *  Give me all blog posts by [authors] that were reblogged by this blog
 */
...
FC_REFLECT_ENUM( zattera::plugins::follow::follow_type, (undefined)(blog)(ignore) )

FC_REFLECT( zattera::plugins::follow::follow_object, (id)(follower)(following)(what) )
CHAINBASE_SET_INDEX_TYPE( zattera::plugins::follow::follow_object, zattera::plugins::follow::follow_index )

FC_REFLECT( zattera::plugins::follow::feed_object, (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(comment)(account_feed_id) )
CHAINBASE_SET_INDEX_TYPE( zattera::plugins::follow::feed_object, zattera::plugins::follow::feed_index )

FC_REFLECT( zattera::plugins::follow::blog_object, (id)(account)(comment)(reblogged_on)(blog_feed_id) )
CHAINBASE_SET_INDEX_TYPE( zattera::plugins::follow::blog_object, zattera::plugins::follow::blog_index )

FC_REFLECT( zattera::plugins::follow::reputation_object, (id)(account)(reputation) )
CHAINBASE_SET_INDEX_TYPE( zattera::plugins::follow::reputation_object, zattera::plugins::follow::reputation_index )

FC_REFLECT( zattera::plugins::follow::follow_count_object, (id)(account)(follower_count)(following_count) )
CHAINBASE_SET_INDEX_TYPE( zattera::plugins::follow::follow_count_object, zattera::plugins::follow::follow_count_index )

FC_REFLECT( zattera::plugins::follow::blog_author_stats_object, (id)(blogger)(guest)(count) )
CHAINBASE_SET_INDEX_TYPE( zattera::plugins::follow::blog_author_stats_object, zattera::plugins::follow::blog_author_stats_index );

namespace helpers
{
   template <>
   class index_statistic_provider<zattera::plugins::follow::feed_index>
   {
   public:
      typedef zattera::plugins::follow::feed_index IndexType;
      typedef typename zattera::plugins::follow::feed_object::t_reblogged_by_container t_reblogged_by_container;
