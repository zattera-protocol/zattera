...
FC_REFLECT( zattera::plugins::witness::exp_bandwidth_update_object,
   (account)
   (type)
   (average_bandwidth)
   (lifetime_bandwidth)
...
FC_REFLECT( zattera::plugins::witness::exp_reserve_ratio_object,
   (average_block_size)
...
FC_REFLECT( zattera::plugins::witness::exp_witness_data_object,
   (bandwidth_updates)
   (reserve_ratio)
   )
