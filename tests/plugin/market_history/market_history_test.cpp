...
BOOST_AUTO_TEST_CASE( track_market_history_and_buckets )
{
   ...
   try
   {
      ...
      BOOST_REQUIRE( bucket->liquid.high == ASSET( "1.500 TTR " ).amount );
      BOOST_REQUIRE( bucket->liquid.low == ASSET( "1.500 TTR" ).amount );
      BOOST_REQUIRE( bucket->liquid.open == ASSET( "1.500 TTR" ).amount );
      BOOST_REQUIRE( bucket->liquid.close == ASSET( "1.500 TTR").amount );
      BOOST_REQUIRE( bucket->liquid.volume == ASSET( "1.500 TTR" ).amount );
      BOOST_REQUIRE( bucket->dollars.high == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->dollars.low == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->dollars.open == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->dollars.close == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->dollars.volume == ASSET( "0.750 TBD" ).amount );

      bucket++;

      BOOST_REQUIRE( bucket->seconds == 15 );
      BOOST_REQUIRE( bucket->open == time_a + ( 60 * 90 ) );
      BOOST_REQUIRE( bucket->liquid.high == ASSET( "0.500 TTR " ).amount );
      BOOST_REQUIRE( bucket->liquid.low == ASSET( "0.500 TTR" ).amount );
      BOOST_REQUIRE( bucket->liquid.open == ASSET( "0.500 TTR" ).amount );
      BOOST_REQUIRE( bucket->liquid.close == ASSET( "0.500 TTR").amount );
      BOOST_REQUIRE( bucket->liquid.volume == ASSET( "0.500 TTR" ).amount );
      BOOST_REQUIRE( bucket->dollars.high == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->dollars.low == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->dollars.open == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->dollars.close == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->dollars.volume == ASSET( "0.250 TBD" ).amount );

      bucket++;

      BOOST_REQUIRE( bucket->seconds == 15 );
      BOOST_REQUIRE( bucket->open == time_a + ( 60 * 90 ) + 60 );
      BOOST_REQUIRE( bucket->liquid.high == ASSET( "0.450 TTR " ).amount );
      BOOST_REQUIRE( bucket->liquid.low == ASSET( "0.500 TTR" ).amount );
      BOOST_REQUIRE( bucket->liquid.open == ASSET( "0.500 TTR" ).amount );
      BOOST_REQUIRE( bucket->liquid.close == ASSET( "0.450 TTR").amount );
      BOOST_REQUIRE( bucket->liquid.volume == ASSET( "0.950 TTR" ).amount );
      BOOST_REQUIRE( bucket->dollars.high == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->dollars.low == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->dollars.open == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->dollars.close == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->dollars.volume == ASSET( "0.500 TBD" ).amount );
      bucket++;
      ...
      BOOST_REQUIRE( bucket->liquid.open == ASSET( "0.500 TTR" ).amount );
      BOOST_REQUIRE( bucket->liquid.close == ASSET( "0.450 TTR").amount );
      BOOST_REQUIRE( bucket->liquid.volume == ASSET( "1.450 TTR" ).amount );
      BOOST_REQUIRE( bucket->dollars.high == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->dollars.low == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->dollars.open == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->dollars.close == ASSET( "0.250 TBD" ).amount );
      ...
      BOOST_REQUIRE( bucket->liquid.open == ASSET( "1.500 TTR" ).amount );
      BOOST_REQUIRE( bucket->liquid.close == ASSET( "0.450 TTR" ).amount );
      BOOST_REQUIRE( bucket->liquid.volume == ASSET( "2.950 TTR" ).amount );
      BOOST_REQUIRE( bucket->dollars.high == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->dollars.low == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->dollars.open == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->dollars.close == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->dollars.volume == ASSET( "1.500 TBD" ).amount );
      bucket++;
