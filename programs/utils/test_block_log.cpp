...
int main( int argc, char** argv, char** envp )
{
   try
   {
      //zattera::chain::database db;
      zattera::chain::block_log log;
      ...
      zattera::protocol::signed_block b1;
      b1.witness = "alice";
      b1.previous = zattera::protocol::block_id_type();
      ...
      zattera::protocol::signed_block b2;
      b2.witness = "bob";
      b2.previous = b1.id();
